...
- S3 上传脚本：`scripts/s3/upload_images_to_s3.py`，输出 `datasets/s3/<S3_DATASET_NAME>/metadata/s3_images.json|csv` 和 `s3_download_urls.txt`。
